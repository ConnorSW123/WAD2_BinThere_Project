...
def populate():
    # First, create some users (or ensure they exist)
    ...
    # Now create some locations (or ensure they exist)
    ...
    # Now create some bin types (or ensure they exist)
    ...
    # Now add some votes for the bins (this will just add votes and not update upvote/downvote counters directly)
    votes_data = [
